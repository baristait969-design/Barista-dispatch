...
export const RolesView: React.FC = () => {
  ...
  const permissionsMatrix = [
    ...
    { module: 'Products - Add & Edit Catalog Items', admin: 'Exclusive Full Access', editor: 'Denied (Read-Only)', viewer: 'Denied (Hidden)' },
    { module: 'Products - System Generated IDs & Temp Limits', admin: 'Automatic (Locked)', editor: 'Automatic (Locked)', viewer: 'Denied (Hidden)' },
    { module: 'Products - Delete & Suspend Items', admin: 'Exclusive Full Access', editor: 'Denied', viewer: 'Denied (Hidden)' },
